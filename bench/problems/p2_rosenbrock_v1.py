...
class P2aRosenbrock2D(BenchProblem):
    ...
    # ARCHIVE: superseded by p2_rosenbrock.py (the new canonical file).
    # Name blanked so the subclass registry skips this archive copy.
    name = ""
    max_steps = 5000
    converged_tol = 1e-4
...
class P2bRosenbrockN100(BenchProblem):
    ...
    # ARCHIVE: legacy 1-D vector version of P2b. Routed to RACASO's L3.
    # Replaced by the matrix-version (10x10) in p2_rosenbrock.py.
    name = ""
    max_steps = 10000
    converged_tol = 1e-3
